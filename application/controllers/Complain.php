...
class Complain extends Admin_Controller 
{
    ...
    public function complainAllList($title)
    {
        //echo urldecode($title);
        $this->data['mail']=$this->Mailmodel->get_all_mail(array('u_title'=>urldecode($title)));                   
        $this->render_template('complain/search_dtls', $this->data);
    }

    public function complainDisposedList($title)
    {
        $this->data['mail']=$this->Mailmodel->get_all_mail(array('u_title'=>urldecode($title),'mt_disposed'=>'Yes'));                   
        $this->render_template('complain/search_dtls', $this->data);
    }

    public function complainPendingList($title)
    {
        $this->data['mail']=$this->Mailmodel->get_all_mail(array('u_title'=>urldecode($title),'mt_disposed'=>'No'));                   
        $this->render_template('complain/search_dtls', $this->data);
    }
