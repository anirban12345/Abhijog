        ...
        <div class="col-sm-12 col-md-12 col-lg-12">
            <div class="card" id="myform">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <input type="date" class="form-control" placeholder="Enter Incident Date (DD-MM-YYYY Format)" id="m_incident_date" name="m_incident_date" value="<?php if(date('d-m-Y',strtotime($r->mt_incident_date))!='01-01-1970'){echo $r->mt_incident_date;}?>">                                                                    
                        </div>
                ...
                <?php } ?>
                                 ...
                                 <?php if($this->session->userdata('userdtls')[0]->u_id==45 || $this->session->userdata('userdtls')[0]->u_id==47 ||$this->session->userdata('userdtls')[0]->u_id==57) {?>
