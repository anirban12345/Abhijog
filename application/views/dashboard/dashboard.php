<div class="page-wrapper">
            ...
            <div class="row" id="welcome">
                ...
                <h2 class="page-title alert alert-primary text-center">All Complaints Status At a Glance</h2>
                    ...
                    <?php foreach($all_data as $r){?>
                    <h2 class="page-title alert alert-primary text-center"><?=$r->u_title?></h2>
                    <div class="row">                    
                    <div class="col-12 col-sm-4">
                        <div class="card bg-primary text-white">
                            <a target="blank" href="<?=base_url('Complain/complainAllList/'.$r->u_title)?>" class="text-white">                            
                                <div class="card-body">
                                    <div class="d-flex no-block align-items-center">
                                        <i class="text-white fas fa-inbox fa-3x"></i>
                                        <div class="m-l-15 m-t-10">
                    ...
                    <div class="col-12 col-sm-4">
                        <div class="card bg-success text-white">
                            <a target="blank" href="<?=base_url('Complain/complainDisposedList/'.$r->u_title)?>" class="text-white">                            
                                <div class="card-body">
                                    <div class="d-flex no-block align-items-center">
                                        <i class="text-white fas fa-envelope fa-3x"></i>
                                        <div class="m-l-15 m-t-10">
                    ...
                    <div class="col-12 col-sm-4">
                        <div class="card bg-danger text-white">
                            <a target="blank" href="<?=base_url('Complain/complainPendingList/'.$r->u_title)?>" class="text-white">                                                      
                                <div class="card-body">
                                    <div class="d-flex no-block align-items-center">
                                        <i class="text-white fas fa-envelope fa-3x"></i>
                                        <div class="m-l-15 m-t-10">
