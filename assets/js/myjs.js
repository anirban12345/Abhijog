...
function drawOrgChart1() {
    $.ajax({
        url: "https://scientificwing.kolkatapolice.org/Abhijog/Api/printHierarchyGraph",
        dataType: "json",
        type: "GET",
        contentType: "application/json; charset=utf-8",
        success: function (data) {
            ...
            $.each(data, function (index, value) {
                datatable.addRows([[value.hname,value.hparent,value.hname],]);                                  
            });
            ...
            // Create the chart.
            var chart = new google.visualization.OrgChart(document.getElementById('org_chart1'));
            chart.draw(datatable, options);      // Draw the chart with Options.
        },
        error: function (XMLHttpRequest, textStatus, errorThrown) {
            alert('Got an Error');
